...
const handleCommandPrerequisites = async (client: discord.Client, interaction: discord.Interaction, command: SlashCommand): Promise<boolean> => {
...
const executeCommand = async (client: discord.Client, interaction: discord.Interaction, command: SlashCommand): Promise<void> => {
