...
class TicketCommandManager {
    ...
    private createConfigCollector(response: discord.Message | discord.InteractionResponse): discord.InteractionCollector<discord.ButtonInteraction | discord.StringSelectMenuInteraction> {
        // Create a collector that accepts any component type
        const collector = (response as discord.Message).createMessageComponentCollector({
            filter: (i) =>
                // Filter only for the user ID and the component types we want
                i.user.id === this.interaction.user.id &&
                (i.componentType === discord.ComponentType.Button ||
                    i.componentType === discord.ComponentType.StringSelect),
 ...
 */
    private async closeSubcommand(): Promise<void> {
        await this.interaction.deferReply();
     ...
     */
    private async reopenSubcommand(): Promise<void> {
        await this.interaction.deferReply();
     ...
     */
    private async addUserSubcommand(): Promise<void> {
        await this.interaction.deferReply();
     ...
     */
    private async removeUserSubcommand(): Promise<void> {
        await this.interaction.deferReply();
     ...
     */
    private async infoSubcommand(): Promise<void> {
        await this.interaction.deferReply();
     ...
     */
    private async statsSubcommand(): Promise<void> {
        await this.interaction.deferReply();
