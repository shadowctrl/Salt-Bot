            ...
            subcommand
                ...
                .addChannelOption(option =>
                    option.setName("channel")
                        .setDescription("Channel to deploy the ticket panel in")
                        .addChannelTypes(
                    ...
                    subcommand
                        ...
                        .addStringOption(option =>
                            option.setName("color")
                                .setDescription("Color for the ticket panel embed (hex code)")
                                .setRequired(false))
                )
                .addSubcommand(subcommand =>
                    subcommand
                        ...
                        .addStringOption(option =>
                            option.setName("name")
                                .setDescription("Name for the ticket category")
                                .setRequired(false))
                        .addStringOption(option =>
                            option.setName("description")
                                .setDescription("Description for the ticket category")
                                .setRequired(false))
                        .addStringOption(option =>
                            option.setName("emoji")
                                .setDescription("Emoji for the ticket category")
                                .setRequired(false))
                        .addRoleOption(option =>
                            option.setName("support_role")
                                .setDescription("Support role for the ticket category")
                                .setRequired(false))
                        .addChannelOption(option =>
                            option.setName("parent_category")
                                .setDescription("Parent category for tickets")
                                .addChannelTypes(discord.ChannelType.GuildCategory)
                                .setRequired(false))
                        .addStringOption(option =>
                            option.setName("category_id")
                                .setDescription("ID of the category to edit/delete (required for edit/delete)")
                                .setRequired(false))
                )
                .addSubcommand(subcommand =>
                    subcommand
                        ...
                        .addStringOption(option =>
                            option.setName("category_id")
                                .setDescription("ID of the category to configure messages for")
                                .setRequired(true))
                        .addStringOption(option =>
                            option.setName("welcome_message")
                                ...
                                .setRequired(false))
                        .addStringOption(option =>
                            option.setName("close_message")
                                .setDescription("Message shown when tickets are closed")
                                .setRequired(false))
                        .addBooleanOption(option =>
                            option.setName("include_support_team")
                                .setDescription("Whether to ping the support team when tickets are created")
                                .setRequired(false))
                )
                .addSubcommand(subcommand =>
                    subcommand
                ...
                await interaction.reply({
                    embeds: [
                        new discord.EmbedBuilder()
                            .setTitle("❌ Error")
                            .setDescription("Database connection is not available.")
                            .setColor("Red")
                    ],
