...
class ButtonTemplate {
	...
	public supportButton(): discord.ButtonBuilder {
		return new discord.ButtonBuilder().setLabel(`${this.client.user?.username} Support`).setEmoji('🛠️').setStyle(discord.ButtonStyle.Link).setURL(this.client.config.bot.support.link);
	}
}
